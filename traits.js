...
const _traits = [
    ...
    },
    {
        ...
        "traitType": "primary",
        "parentTraits": [],
        "trait_definition": "Niche vibe can be present in Initial Reaction and/or Context Prompt. A comment that expresses or implies that an idea will appeal to an explicit subset of the entire universe of potential consumers OR that an idea is appropriate only for more specialized occasions that are more narrow or limited than how the idea is intended to—or could feasibly—be used. • Good examples of subset audiences include (but are not limited to) people with targetable characteristics, such as kids, older or younger consumers, those with medical conditions, certain lifestyles (e.g., fitness fiends), etc. • Good examples of specialized occasions include (but are not limited to) those that are typically associated with a limited timeframe or special \"once in a while\" events, like holidays, when traveling, during specific seasons, etc. Niche comments can be POSITIVE (e.g., \"this is great for kids\" or \"perfect for the holidays\"), NEUTRAL (e.g., \"vegans and vegetarians would like this\" or \"seems like a summertime thing\"), or even have a NEGATIVE element or tone (e.g., \"health nuts might be into this, but no one else would\").",
        "trait_examples": "\"Kids would like it as a snack on the way to sporting events or travelling somewhere.\" | \"Peppermint is perfect for the holidays and the pecan pumpkin is definitely a fall flavor.\" | \"Health conscious, diabetics, or anyone who wants a healthy treat\" | \"Diabetics or people with food restrictions. Athletes. People who care what goes into their bodies. Hiking, jogging, football, volleyball, after swimming. Great to take camping.\" | \"I think it would be useful, especially for people who like to make desserts for holiday parties or family gatherings.\""
    },
    {
    ...
    {
        "_id": "62822011793707eaf32b23fa",
        "gcsFileName": "Fixable (Prompted).h5",
        "contextPromptEnabled": true,
        "initialReactionEnabled": false,
        "expandedView": false,
        "hideThemeTag": false,
