const traits = [
  ...
  },
  {
    ...
    "title": "(EMOTIVE DELIGHT) Enticing",
    "traitType": "secondary",
    "trait_definition": "Emotive Delight directly associated with anticipation about how the product could feel, taste, smell, or be experienced.",
    "trait_examples": "Sounds delicious, I would love to try all three! | Sounds very tasty. I like the dark chocolate and nuts, makes me feel hungry! | I think it sounds amazingly delicious."
  },
  {
  ...
  {
    "_id": "627d49624bcce8cde00dbdc6",
    "gcsFileName": "(FORESIGHT) On the Go.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "title": "(FORESIGHT) On the Go",
    "traitType": "secondary",
    "trait_definition": "Foresight directly associated with the concept perceived to be useful when on the go or while out and about.",
    "trait_examples": "It would be very convenient for those on the go in the morning | It's something that I personally would try especially if I'm on the go | Yes people like easy things on the go. | I feel like people are always looking for quick, healthy, no fuss snacks to take on the go"
  },
  {
  ...
  {
    "_id": "6178f26523c29c21b201d748",
    "gcsFileName": "(BLAH) Old News.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "color": "negative",
    "parentTraits": [
      "6178f26523c29c21b201d763"
    ],
    "title": "(BLAH) Old News",
    "traitType": "secondary",
    "trait_definition": "Blah vibe characterized as boring, dull, not unique, etc.",
    "trait_examples": "It's a lot like many products on the market now | Not so new or different"
  },
  {
    "_id": "6178f26523c29c21b201d749",
    "gcsFileName": "(BLAH) Lacks Distinction (Me Too).h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "title": "(BLAH) Lacks Distinction (Me Too)",
    "traitType": "secondary",
    "trait_definition": "Blah vibe directly associated with sounding like other perceived competitors of the concept, trying to copy what other brands are doing.",
    "trait_examples": "It seems just like all the other brands | It seems fine, but basically indistinguishable from just about every other kind of cat litter"
  },
  {
    "_id": "6178f26523c29c21b201d75f",
    "gcsFileName": "(OVERPRICED) Assumed Expensiveness.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "color": "negative",
    "parentTraits": [
      "6178f26523c29c21b201d76f"
    ],
    "title": "(OVERPRICED) Assumed Expensiveness",
    "traitType": "secondary",
  ...
  },
  {
    ...
    "gcsFileName": "(NOT FOR ME) Category.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "title": "(NOT FOR ME) Category",
    "traitType": "secondary",
    "trait_definition": "Not For Me directly associated with the category in which the concept or product falls under.",
    "trait_examples": "I don't like yogurt, so personally it does not appeal to me | I personally don't like clumping cat litter"
  },
  {
    "_id": "6178f26523c29c21b201d761",
    "gcsFileName": "(POINTLESS) Gimmick.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "color": "negative",
    "parentTraits": [
      "6178f26523c29c21b201d770"
    ],
    "title": "(POINTLESS) Gimmick",
    "traitType": "secondary",
    "trait_definition": "",
    "trait_examples": "Just another gimmick. Why can't coffee just be coffee?! | Ridiculous, another fad, cash in on the trend, hate Starbucks anyway for so many reasons"
  },
  {
    "_id": "6178f26523c29c21b201d762",
    "gcsFileName": "(POINTLESS) No Need.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "title": "(POINTLESS) No Need",
    "traitType": "secondary",
    "trait_definition": "",
    "trait_examples": "This is unnecessary and superfluous | I don't know what the purpose would be."
  },
  {
  ...
  // {
  //   "_id": "629029c550941e45c793ee4f",
  //   "__v": 0,
  //   "gcsFileName": null,
  //   "initialReactionEnabled": true,
  //   "contextPromptEnabled": false,
  //   "expandedView": true,
  //   "description": "New News or attention-grabbing vibe",
  //   "hideThemeTag": false,
  //   "color": "positive",
  ...
  // },
  // {
  //   "_id": "62902a2050941e45c793ee53",
  //   "__v": 0,
  //   "gcsFileName": null,
  //   "initialReactionEnabled": true,
  //   "contextPromptEnabled": false,
  //   "expandedView": true,
  //   "description": "Blah, old news, or me-too vibe",
  //   "hideThemeTag": false,
  //   "color": "negative",
  //   "title": "Meh Vibe",
  //   "traitType": "composite",
  ...
  // },
  // {
  //   "_id": "62902e98c59541c5cc059c64",
  //   "__v": 0,
  //   "gcsFileName": null,
  //   "initialReactionEnabled": true,
  //   "contextPromptEnabled": false,
  //   "expandedView": true,
  //   "description": "Explicit Niche Vibe or Alluring who/what/when/where context",
  //   "hideThemeTag": false,
  //   "color": "neutral",
  //   "title": "Primed Mindset Vibe",
  //   "traitType": "composite",
  //   "parentTraits": [],
  //   "trait_definition": "",
  //   "trait_examples": ""
  // },
  // {
  //   "_id": "629044fd4ec32f7c46fabc05",
  //   "__v": 0,
  //   "gcsFileName": null,
  //   "initialReactionEnabled": true,
  //   "contextPromptEnabled": false,
  //   "expandedView": true,
  //   "description": "Average or higher word count",
  //   "hideThemeTag": true,
  //   "color": "positive",
  //   "title": "Expressive (Average or Higher)",
  //   "traitType": "composite",
  //   "parentTraits": [],
  //   "trait_definition": "",
  //   "trait_examples": ""
  // },
  // {
  //   "_id": "629045184ec32f7c46fabc07",
  //   "__v": 0,
  //   "gcsFileName": null,
  //   "initialReactionEnabled": true,
  //   "contextPromptEnabled": false,
  //   "expandedView": true,
  //   "description": "A perception of questionable value or expected expensiveness",
  //   "hideThemeTag": false,
  //   "color": "positive",
  //   "title": "Overpriced Vibe",
  //   "traitType": "composite",
  //   "parentTraits": [],
  //   "trait_definition": "",
  //   "trait_examples": ""
  // },
  {
    "_id": "6178f26523c29c21b201d74a",
    "gcsFileName": "(BUST) Bad Idea.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "color": "negative",
    "parentTraits": [
      "6178f26523c29c21b201d764"
    ],
    "title": "(BUST) Bad Idea",
    "traitType": "secondary",
    "trait_definition": "Bust vibe direcly associated with an explicit and firm statement indicating they think the concept is a bad idea.",
    "trait_examples": "I don't think it would work. Corn is not absorbing"
  },
  {
  ...
  {
    "_id": "6178f26523c29c21b201d74b",
    "gcsFileName": "(BUST) Emotive Disgust or Contempt.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "title": "(BUST) Emotive Disgust or Contempt",
    "traitType": "secondary",
    "trait_definition": "Bust vibe triggered by emotional disgust or contempt, with clear personal and harsh rejection.",
  ...
  {
    "_id": "6178f26523c29c21b201d760",
    "gcsFileName": "(OVERPRICED) Explicit Price Sensitivity.h5",
    "contextPromptEnabled": false,
    "initialReactionEnabled": true,
    "expandedView": false,
    "hideThemeTag": false,
    ...
    "title": "(OVERPRICED) Explicit Price Sensitivity",
    "traitType": "secondary",
    "trait_definition": "Overpriced vibe that mainly only shows up for priced concepts. Explicit negative statement made about the product cost being prohibitive or too expensive.",
    "trait_examples": "I think it's too expensive for people to try | Nothing special, just sounds unnecessarily expensive"
  },
  {
